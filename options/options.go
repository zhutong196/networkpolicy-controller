...
func NewNetworkPolicyControllerConfig() *NetworkPolicyControllerConfig {
	return &NetworkPolicyControllerConfig{
...
func (s *NetworkPolicyControllerConfig) AddFlags(fs *pflag.FlagSet) {
